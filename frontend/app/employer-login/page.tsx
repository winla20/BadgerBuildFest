...
export default function EmployerLoginPage() {
  ...
  const handleLogin = (e: React.FormEvent) => {
    ...
    setTimeout(() => {
      router.push(accountType === 'institution' ? '/institution' : '/employer-dashboard');
    }, 1000);
  };
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-cyan-50 to-teal-50 flex items-center justify-center px-4 sm:px-8 relative overflow-hidden">
      ...
      <div className="relative w-full max-w-lg">
        ...
        {/* Sign In Form */}
        <div className={`bg-white/80 backdrop-blur-xl border p-8 md:p-12 rounded-3xl shadow-2xl transition-all ${
          accountType === 'employer'
          ...
          <h2 className="text-3xl text-slate-900 mb-8 font-semibold">
            Sign in
          </h2>
