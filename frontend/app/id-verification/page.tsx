...
/**
 * IDVerificationPage Component
 * 
 * Page for institutions to verify student credentials and identities.
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-cyan-50 to-teal-50 py-12 px-4 sm:px-8 relative overflow-hidden">
      ...
      <div className="relative max-w-3xl mx-auto">
        ...
        {/* Form */}
        <div className="bg-white/80 backdrop-blur-xl border border-indigo-200/50 rounded-3xl shadow-2xl shadow-indigo-500/10 p-6 md:p-10">
          <form onSubmit={handleVerify} className="space-y-8">
            {/* User ID */}
            <div>
              <label className="text-indigo-700 text-xl mb-4 block font-medium">
                User ID
              </label>
              <input
                type="text"
                ...
                className="w-full border-2 border-indigo-200/50 focus:border-indigo-500 rounded-xl h-14 text-lg bg-white/50 backdrop-blur-sm px-4 focus:outline-none"
              ...
              <div className="border-2 border-indigo-200/50 rounded-2xl p-10 min-h-[160px] flex items-center justify-center bg-gradient-to-br from-indigo-50/50 to-purple-50/50 backdrop-blur-sm">
                {status === null ? (
                  ...
                  <div className="text-center">
                    ...
                    <p className={`text-2xl font-semibold ${status === 'approved' ? 'text-emerald-600' : 'text-orange-600'}`}>
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <button
                type="submit"
                className="flex-1 bg-gradient-to-r from-indigo-600 to-purple-600 hover:from-indigo-700 hover:to-purple-700 text-white h-14 text-lg rounded-xl hover:shadow-lg hover:shadow-indigo-500/30 transition-all font-medium"
              >
                Verify Credentials
              </button>
              <Link
                href="/institution"
                className="flex-1 border-2 border-slate-300 hover:bg-slate-50 h-14 text-lg rounded-xl hover:shadow-md transition-all font-medium flex items-center justify-center gap-2"
              >
        ...
        {/* Additional Info */}
        {status !== null && (
          <div className="mt-8 p-6 md:p-8 bg-white/80 backdrop-blur-xl border border-indigo-200/50 rounded-3xl shadow-xl">
            <h3 className="text-xl text-slate-900 mb-6 font-semibold">Verification Details</h3>
